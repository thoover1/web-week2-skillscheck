...
// Code Here
let doubled = myNumbers.map(double => double * 2);
...
// Code Here
let filtered = doubled.filter(hundred => hundred > 100);
...
// Code Here
let total = filtered.reduce((gainer, filtered) => gainer + filtered, 0);
...
// Code Here
let myNumbersIndex = [];
myNumbers.forEach(function(sum, index) {
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(rename => "george");
//////////////////PROBLEM 19////////////////////
...
// Code Here
const friends = people.filter(fries => (fries.friend = true));
...
// Code Here
let totallyAwesome = people.reduce(sweet => sweet.awesomeLevel);
